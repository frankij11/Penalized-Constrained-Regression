...
class PCRegBase(SimulationModel):
    ...
    def _build_regressor_params(self) -> Dict[str, Any]:
        ...
        params = {
            ...
            'x0': init,
            'loss': 'sspe',
            'penalty_exclude': ['T1'],  # Don't penalize the scale parameter
        }
    ...
    def get_regularization_params(self) -> Dict[str, Any]:
        ...
        if hasattr(self.regressor_, 'converged_'):
            ...
            warnings.warn(f"converged_ attribute missing from {self.regressor_.__class__.__name__}")
...
class PCRegLogSpaceBase(SimulationModel):
    ...
    def _build_regressor_params(self) -> Dict[str, Any]:
        ...
        params = {
            ...
            'intercept_bounds': None,  # T1 > 0 means log(T1) can be any real number
